...
- (int)joinSubChannelByToken:(NSString * _Nullable)token
                   channelId:(NSString * _Nonnull)channelId
                        info:(NSString * _Nullable)info
                         uid:(NSUInteger)uid
                 joinSuccess:(void(^ _Nullable)(NSString * _Nonnull channel, NSUInteger uid, NSInteger elapsed))joinSuccessBlock;

- (int)publishOnChannel:(NSString * _Nonnull)channelId;
...
- (int)leaveSubChannel:(void(^ _Nullable)(AgoraChannelStats * _Nonnull stat))leaveChannelBlock;
...
#pragma mark Mark Custom Media Metadata

/** Sets the media metadata dataSource
 User should call this method before JoinChannel.
 @param metadataDataSource AgoraMediaMetadataDataSource.
 @param type The type of the metadata of the Metadata DataSource
...
/** Sets the media metadata delegate
 User should call this method before JoinChannel.
 @param metadataDelegate AgoraMediaMetadataDelegate
 @param type The type of the metadata to the Metadata Delegate
 @return * YES: success. NO: fail.
 */
...
@property (nonatomic, weak) id<AgoraRtcEngineDelegate> _Nullable subDelegate;
